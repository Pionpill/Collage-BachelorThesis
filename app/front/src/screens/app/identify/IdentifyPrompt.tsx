...
import { toggleIdentifyHelpPrompt } from "../../../store/features/identifySlice";
import { partOpacitySx } from "../../../styles/macro";

const IdentifyPrompt: React.FC<{ sx?: SxProps }> = ({ sx }) => {
    ...
    <PromptCard sx={sx}>
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FormControlLabel
          ...
          label="显示全部"
        />
        <Button onClick={() => dispatch(toggleIdentifyHelpPrompt())}>
          隐藏提示栏
        </Button>
      </CardActions>
    </PromptCard>
